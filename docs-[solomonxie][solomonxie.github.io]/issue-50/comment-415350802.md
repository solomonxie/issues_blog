...
![image](https://user-images.githubusercontent.com/14041622/44644934-59ed8a00-aa08-11e8-9fc3-cb8791834280.png)

This formula is good for `P(X<a)`, and with a bit twist you could get most of it.
etc., 
- `P(X≥4)` is the same with `1 - P(X<4)`
- `P(X≤7)` is the same with `P(X<8)`
