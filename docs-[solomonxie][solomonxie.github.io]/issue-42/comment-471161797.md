...
`OpenAPI` is a _protocol_ generally recognized that more and more organizations in the world apply it in their API architecture just like`REST` or `OAuth`. Or you want to see it as a _blueprint_ of a building and you don't want to construct a building without a blueprint.
