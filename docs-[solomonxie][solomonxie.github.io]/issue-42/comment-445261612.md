...
完成后，每个页面的Header或URL中，都会自动增加一个`access_token`值，如果以前有则会被覆盖。
![image](https://user-images.githubusercontent.com/14041622/49668388-e5ab9380-fa98-11e8-8849-e768b0149fcc.png)

注意看，`authentication`的值里，已经默认加上了`Bearer`前缀及后面的base64编码字符串。
