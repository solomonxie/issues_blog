...
- `r=1` when the line fits **ALL** data points. The better the line fits the data points, the `r` is closer to 1.
- `r=0` when there's NO **correlation** or `linear relationship`.
