# `Box plots` and `Quartiles`  (Distribution graph)
It's also called `Box and whisker plots`, or `Five-number summary`.

[Jump back to the original note](https://github.com/solomonxie/solomonxie.github.io/issues/44#issuecomment-370158257)
