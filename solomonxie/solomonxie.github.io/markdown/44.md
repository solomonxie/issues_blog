...
- Types by side length: `Equilateral triangles` with 3 equal sides, `Isosceles triangles` with 2 equal sides, `Scalene triangles` with all different sides.
- Types by angles: `Acute triangles` with 3 acute angles, `Obtuse triangles` with 1 obtuse angle, `Right triangles` with 1 right angle.
