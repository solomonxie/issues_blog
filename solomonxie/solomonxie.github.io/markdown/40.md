...
`direction angle` is a term for vectors. It is the angle we care about for a vector, which is in between of the vector line and the positive side of axsis-x.
